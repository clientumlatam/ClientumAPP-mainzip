  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-slate-50">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 bg-white">
        ...
        <div className="px-3 py-2 border-l border-slate-200 flex items-center gap-2 shrink-0">
          <button
                  ...
                  {stageOpps.length === 0 ? (
                    ...
                    stageOpps.map((opp) => (
                      <div
                        ...
                        className="p-3 rounded-lg bg-white hover:bg-slate-50 border border-slate-200 hover:border-blue-300 shadow-xs hover:shadow-md cursor-grab active:cursor-grabbing transition-all group relative"
                      >
                        {/* Deal Name & Amount */}
